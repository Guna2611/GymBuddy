...
const seedData = async () => {
    try {
        ...
        // Get gym owner
        const gymOwner = users.find(u => u.role === 'gymOwner');
        ...
        const gyms = await Gym.create([
            {
                ...
                address: { street: 'Link Road', city: 'Mumbai', area: 'Andheri West', state: 'Maharashtra', zipCode: '400053' },
            ...
            },
            {
                owner: gymOwner._id,
                name: 'Iron Paradise',
                address: { street: 'Turner Road', city: 'Mumbai', area: 'Bandra West', state: 'Maharashtra', zipCode: '400050' },
                ...
                openingHours: { weekdays: { open: '06:00', close: '22:00' }, weekends: { open: '07:00', close: '20:00' } },
            ...
            },
            {
                ...
                address: { street: 'Hiranandani Gardens', city: 'Mumbai', area: 'Powai', state: 'Maharashtra', zipCode: '400076' },
                ...
                openingHours: { weekdays: { open: '06:00', close: '21:00' }, weekends: { open: '07:00', close: '19:00' } },
            ...
            },
            {
                owner: gymOwner._id,
                name: 'PowerHouse Gym',
                address: { street: 'Rajouri Garden', city: 'Delhi', area: 'West Delhi', state: 'Delhi', zipCode: '110027' },
                ...
                openingHours: { weekdays: { open: '05:30', close: '22:30' }, weekends: { open: '06:30', close: '20:30' } },
            ...
            },
            {
                ...
                address: { street: '80 Feet Road', city: 'Bangalore', area: 'Koramangala', state: 'Karnataka', zipCode: '560034' },
                ...
                openingHours: { weekdays: { open: '05:00', close: '23:00' }, weekends: { open: '06:00', close: '22:00' } },
        ...
        // Create a sample collaboration ticket
        ...
        console.log('   Gym Owner: gymowner@example.com / password123');
