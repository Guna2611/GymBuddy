...
import { MapPin, Star, Clock, Dumbbell, IndianRupee, ArrowLeft, Loader2, XCircle } from 'lucide-react';
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="glass-card p-6 border-primary/20">
                                        ...
                                        <p className="text-xs text-dark-300 mb-4">Select this gym when creating a collaboration ticket with your partner.</p>
                                        <Link to="/tickets" className="btn-primary w-full justify-center text-sm py-2.5">
                                            View My Tickets
                                        </Link>
                                    </div>
                                </div>
